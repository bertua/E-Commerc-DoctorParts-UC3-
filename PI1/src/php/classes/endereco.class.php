...
class Endereco {
    ...
    // Removido método duplicado deletarEndereco($id_endereco)
    public function deletarEndereco($id_endereco, $id_usuario)
    {
        ...
        try {
            // Verifica se o endereço pertence ao usuário e se é padrão
            $sqlCheck = "
                SELECT padrao 
                FROM enderecos 
            ...
            if (!$endereco) {
                return 0; // Endereço não existe ou não pertence ao usuário
            }
